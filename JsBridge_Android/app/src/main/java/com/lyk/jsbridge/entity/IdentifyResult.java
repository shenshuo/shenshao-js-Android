package com.lyk.jsbridge.entity;
...
public class IdentifyResult implements Serializable {
    ...
    public String toString() {
        return "IdentifyResult{" +
                ...
                ", name_confidence_all=" + name_confidence_all +
                ", sex_confidence_all=" + sex_confidence_all +
                ", nation_confidence_all=" + nation_confidence_all +
                ", birth_confidence_all=" + birth_confidence_all +
                ", address_confidence_all=" + address_confidence_all +
                ", id_confidence_all=" + id_confidence_all +
                ", frontimage_confidence_all=" + frontimage_confidence_all +
                ", watermask_confidence_all=" + watermask_confidence_all +
                ", valid_date_confidence_all=" + valid_date_confidence_all +
                ", authority_confidence_all=" + authority_confidence_all +
                ", backimage_confidence_all=" + backimage_confidence_all +
                ", detail_errorcode=" + detail_errorcode +
                ", detail_errormsg=" + detail_errormsg +
                '}';
    }
}
